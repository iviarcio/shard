...
int main(int argc, char **argv) {
  ...
  // Register ShardToLLVM passes (eliminate shard dialect ops
  // into core MLIR dialects).
  mlir::hexagon::registerShardToLLVMPasses();

  // Register NSP dialect extensions and interface models so that
  // sharding propagation can cross non-shard boundary ops.
  mlir::hexagon::registerNSPDialectExtensions(registry);
  // Register NSP passes and pipelines
  mlir::hexagon::registerNSPPasses();
  mlir::hexagon::registerNSPPipelines();
